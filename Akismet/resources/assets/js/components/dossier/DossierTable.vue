<template>
    <div class="dossier-table-wrapper">
        ...
        <!-- Replaced this from the stock code -->
        <div v-if="showBulkActions" :class="{ 'bulk-actions': true, 'no-checkboxes': !hasCheckboxes }">
            <button type="button" class="btn btn-primary" @click.prevent="call('approveMultiple', checkedItems)">
                Approve {{ checkedItems.length }} {{ translate_choice('cp.items', checkedItems.length)}}
            </button>
            <button type="button" class="btn btn-delete" @click.prevent="call('discardMultiple', checkedItems)">
                Discard {{ checkedItems.length }} {{ translate_choice('cp.items', checkedItems.length)}}
            </button>
        </div>
        <!-- Replaced this from the stock code -->
...
module.exports = {
    ...
    methods: {
        ...
        checkAllItems: function () {
            ...
            console.log(this.items.length, this.checkedItems.length);
        },
